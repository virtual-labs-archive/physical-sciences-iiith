...
d=['introduction','theory','objective','lab','manual','quizzes','further_readings','procedure','hh','ll']
print len(sectionno)
sectionNumber=1
st=""
...
breadcrumb='<a href="http://vlabs.ac.in/physical-sciences-labs.html" class="sidebar-a" >Computer Science & Engineering</a> &rarr;<a href="../Introduction.html" class="sidebar-a" >'+heading1+'</a>&nbsp&rarr;<a href="../Experiments.html" class="sidebar-a" >List Of Experiments</a><br/>'
while sectionNumber<=len(sectionno):
	...
	if tag1=='Prerequisite S/W':
		tag1='Prerequisites'
	st+='<a href="'+tag1+'.html?domain=Physical Sciences&lab='+heading1+'" class="sidebar-a" > <h3 class="text-h3-darkblue" style="margin-top: 2px;">'+tag1+'</h3></a>'	
	sectionNumber=sectionNumber+1
st+='<a href="Feedback.html?domain=Physical Sciences&lab='+heading1+'" class="sidebar-a" > <h3 class="text-h3-darkblue" style="margin-top: 2px;">Feedback</h3></a>'
sectionNumber=1
while sectionNumber<=len(sectionno):
	tag=""
	tag=""
